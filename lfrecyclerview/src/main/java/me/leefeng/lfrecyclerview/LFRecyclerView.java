    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (isLoadMore && mPullLoading && layoutManager.findLastVisibleItemPosition() == adapter.getItemCount() - 1
...
//                super.onScrolled(recyclerView, dx, dy);
    ...
    public void onScrollChange(View view, int i, int i1) {
        ...
        if (isAutoLoadMore && (layoutManager.findLastVisibleItemPosition() == adapter.getItemCount()
                - 1)
...
//        super.requestLayout();
//        if (recyclerViewFooter == null || adapter == null || !isNoDateShow) {
//            return;
//        }
//        boolean b ;
