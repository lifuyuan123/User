package com.example.mayikang.wowallet.contact.decoration;
...
import com.example.mayikang.wowallet.contact.IndexBar.bean.BaseIndexTagBean;
...
public class TitleItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public TitleItemDecoration(Context context, List<? extends ContactBean> datas) {
        super();
        mDatas = datas;
        mPaint = new Paint();
        mBounds = new Rect();
