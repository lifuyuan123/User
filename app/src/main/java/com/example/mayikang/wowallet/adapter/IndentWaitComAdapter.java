...
public class IndentWaitComAdapter extends RecyclerView.Adapter<IndentWaitComAdapter.IndentWaitComViewHolder> {

    private LayoutInflater inflater;
    private Context mContext;
    private List<IndentBean> data;

    public IndentWaitComAdapter(Context mContext, List<IndentBean> data) {
    ...
    @Override
    public IndentWaitComViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view=null;
        switch (viewType){
            case 1:
        ...
        return new IndentWaitComViewHolder(view,viewType);
    }


    @Override
    public void onBindViewHolder(IndentWaitComViewHolder holder, final int position) {
    ...
    public class IndentWaitComViewHolder extends RecyclerView.ViewHolder {
        //返利
        ...
        public IndentWaitComViewHolder(View itemView,int viewType) {
            super(itemView);
            if(null!=itemView){
                switch (viewType){
                    case 1:
    ...
    public interface IndentWaitAdapterCallBack {
        public void itemOnClick(int position);
        public void comment(int position,int id);
    }
    private IndentWaitAdapterCallBack callBack;

    public void setListener(IndentWaitAdapterCallBack callBack) {
